...
<title>修改-职位</title>
<meta name="keywords" content="修改-职位">
<meta name="description" content="修改-职位">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5436"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/job_msg/update_submit',
		data:{
			"id":'${data.id}',
			"jobName":jobName,
			"departId":departId
