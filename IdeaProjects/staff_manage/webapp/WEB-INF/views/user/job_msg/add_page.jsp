...
<title>新增-职位</title>
<meta name="keywords" content="新增-职位">
<meta name="description" content="新增-职位">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="jobNameParentContent">
								...
								<input type="text" value="" placeholder="请输入职位名" id="jobName" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=3139"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/job_msg/add_submit',
		data:{
			"jobName":jobName,
			"departId":departId
		},
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/user/job_msg";
			}
		}
	});
}
