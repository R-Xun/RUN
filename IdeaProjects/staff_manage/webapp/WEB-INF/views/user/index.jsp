		...
		<div class="sidebar-collapse">
			<ul class="nav" id="side-menu">
				<li style="padding:8px;">
					<a  href="#"><h3 style="color:white;text-align:center">人事管理系统</h3></a>
				</li>
				<li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">部门</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/user/depart_msg" >部门管理 </a>
						</li>
					</ul>
					</li><li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">职位</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/user/job_msg" >职位管理 </a>
						</li>
					</ul>
					</li><li>
					...
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/user/staff_msg" >员工管理 </a>
						</li>
					</ul>
					</li>
					...
					<li>
					<a href="javascript:void(0)"><i class="fa fa-edit"></i> <span class="nav-label">用户</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li>
							<a  href="javascript:void(0)" onclick="gotoPage(this)" data-url="${pageContext.request.contextPath}/user/user_msg" >用户管理 </a>
						</li>
					</ul>
				</li>
					</c:if>
	...
	<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 935px;">
		...
		<div class="row" >
			<div class="content" style="width:100%;">
				<iframe  id="iframeDom" style="position:absolute; width: 100%; height:835px; top: 0;border:0px ;margin-top:60px"   src="${pageContext.request.contextPath}/user/depart_msg"></iframe>
			</div>
			<div class="footer">
				<div>
					人事管理系统
