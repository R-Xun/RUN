...
<title>新增-用户</title>
<meta name="keywords" content="新增-用户">
<meta name="description" content="新增-用户">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							...
							<div class="form-group" id="userTypeParentContent">
								<label>权限类型<span style="color:red">(*必填)</span></label>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0779"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/user_msg/add_submit',
		data:{
			"loginName":loginName,
			"password":password,
			"userType":userType
		...
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/user/user_msg";
			}
		}
	});
}
