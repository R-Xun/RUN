...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2824"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/user_msg/update_submit',
		data:{
			"id":'${data.id}',
			"loginName":loginName,
			"password":password,
