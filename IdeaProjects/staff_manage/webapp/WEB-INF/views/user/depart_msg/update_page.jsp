...
<title>修改-部门</title>
<meta name="keywords" content="修改-部门">
<meta name="description" content="修改-部门">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="dnameParentContent">
								<label>部门名<span style="color:red">(*必填)</span></label>
								<input type="text" value="${data.dname}" placeholder="请输入部门名" id="dname" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8372"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/depart_msg/update_submit',
		data:{
			"id":'${data.id}',
			"dname":dname
		},
		success: function(result) {
			if(result.code == 0){
				...
				alert(result.msg);
				window.location.href="${pageContext.request.contextPath}/user/depart_msg";
			}
		}
	});
}
