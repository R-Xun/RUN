...
<title>新增-部门</title>
<meta name="keywords" content="新增-部门">
<meta name="description" content="新增-部门">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="dnameParentContent">
								...
								<input type="text" value="" placeholder="请输入部门名" id="dname" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4465"></script>
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/depart_msg/add_submit',
		data:{
			"dname":dname
		},
