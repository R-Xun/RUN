...
<title>修改-员工</title>
<meta name="keywords" content="修改-员工">
<meta name="description" content="修改-员工">
					...
					<div class="row"   style="width:80%;margin-left:10%">
						<div class="col-lg-6">
							<div class="form-group" id="staffNoParentContent">
								...
								<input type="text" value="${data.staffNo}" placeholder="请输入职工号" id="staffNo" class="form-control">
							</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4645"></script>
...
function changeDepartIdVal(){
	...
	$.ajax({
		...
		success: function(result) {
			...
			$(".searchable-select-holder").css("height","35px");
			$(".searchable-select").css("min-width","40px");
			if('${data.jobId}'!=''&&'${data.jobId}'!='null'&&'${data.jobId}'!=null){
...
function submitData(){
	...
	$.ajax({
		type: 'post',
		url: '${pageContext.request.contextPath}/user/staff_msg/update_submit',
		data:{
			"id":'${data.id}',
			"staffNo":staffNo,
			"realName":realName,
